...
#define CLK_FLAG                                0x100
#define CLOCK_CLKOUTX2		                (1 << 5)
#define OMAP4430_DPLL_CLKOUTX2_GATE_CTRL_MASK	(1 << 10)
#define OMAP4430_DPLL_CLKOUT_GATE_CTRL_MASK	(1 << 8)
/* CM2 base address */
#define OMAP4430_CM2_BASE		0x4a008000
#define OMAP4430_CM_DIV_M5_DPLL_PER				\
	OMAP2_L4_IO_ADDRESS(OMAP4430_CM2_BASE + (0x0100) + (0x005c))
...
int dsi_vc_mcs_write_nosync(struct omap_dss_device *dssdev, int channel,
		u8 *data, int len);		
/* patch end */
/* Preetam : 0001-Fix-for-supporting-interleaving-sending-the-non-vide.patch */
void omapdss_dsi_vc_enable_lp_cmd_mode(struct omap_dss_device *dssdev, int channel, int cmd);
/*  Patch end */
