...
struct twl4030_platform_data {
	...
	/* TWL6030 SMPS regulators */
	struct regulator_init_data              *v1v29;
	struct regulator_init_data              *v1v8;
	struct regulator_init_data              *vcore1;//match PMIC PIN vcore1, don't use the name 'vdd1'
	struct regulator_init_data              *vcore2;//match PMIC PIN vcore2, don't use the name 'vdd2'
	struct regulator_init_data              *vcore3;		
