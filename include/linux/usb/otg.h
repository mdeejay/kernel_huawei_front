...
enum plugin_status {
	PLUGIN_DEVICE_NONE,         /* no charger plugin */
	PLUGIN_USB_CHARGER,         /* plugin usb charger */
	PLUGIN_AC_CHARGER,           /* plugin ac charger */
};
...
extern enum plugin_status get_plugin_device_status(void);
