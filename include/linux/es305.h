/* include/linux/es305.h - es305 voice processor driver
 *
...
#define ES305_MAX_FW_SIZE	(100*1024)
struct es305img {
	unsigned char *buf;
	unsigned img_size;
};
...
enum ES305_PathID {
	...
	ES305_PATH_INCALL_HEADPHONE,
	ES305_PATH_INCALL_SPEAKER,
	ES305_PATH_INCALL_BT,

	ES305_PATH_INCALL_RECEIVER_WB,
	ES305_PATH_INCALL_HEADSET_WB,
	ES305_PATH_INCALL_HEADPHONE_WB,
	ES305_PATH_INCALL_SPEAKER_WB,
	ES305_PATH_INCALL_BT_WB,
...
/* indicates if es305_set_config() performs a full configuration or only
 * a voice processing algorithm configuration */
/* IOCTLs for Audience ES305 */
#define ES305_IOCTL_MAGIC 'u'

#define ES305_BOOTUP_INIT  _IOW(ES305_IOCTL_MAGIC, 0x01, struct es305img *)
#define ES305_SET_CONFIG   _IOW(ES305_IOCTL_MAGIC, 0x02, enum ES305_PathID)
#define ES305_SET_NS_STATE _IOW(ES305_IOCTL_MAGIC, 0x03, enum ES305_NS_states)

/* For Diag */
#define ES305_SET_MIC_ONOFF	_IOW(ES305_IOCTL_MAGIC, 0x50, unsigned)
#define ES305_SET_MICSEL_ONOFF	_IOW(ES305_IOCTL_MAGIC, 0x51, unsigned)
#define ES305_READ_DATA		_IOR(ES305_IOCTL_MAGIC, 0x52, unsigned)
#define ES305_WRITE_MSG		_IOW(ES305_IOCTL_MAGIC, 0x53, unsigned)
#define ES305_SYNC_CMD		_IO(ES305_IOCTL_MAGIC, 0x54)
#define ES305_SET_CMD_FILE	_IOW(ES305_IOCTL_MAGIC, 0x55, unsigned)
#define ES305_RESET_CMD	        _IO(ES305_IOCTL_MAGIC, 0x56)
...
#define A100_HW_Passthrough    0x805200E2
...
#define ES305_msg_VP_ON		0x801C0001
#define ES305_msg_VP_OFF	0x801C0000
...
#define ES305_CMD_FIFO_DEPTH	64
...
//	uint32_t gpio_es305_micsel;
	uint32_t gpio_es305_wakeup_uart1;
	uint32_t gpio_es305_wakeup_uart3;
//	uint32_t gpio_es305_reset;
//	uint32_t gpio_es305_int;
//	uint32_t gpio_es305_clk;
};


#endif /* __KERNEL__ */
#endif /* __LINUX_ES305_H */
