...
#define OMAP4460_VDD_MPU_OPP70_UV		1075000
#define OMAP4460_VDD_MPU_OPP100_UV		1203000
#define OMAP4460_VDD_MPU_OPPTURBO_UV		1317000
#define OMAP4460_VDD_MPU_OPPTURBO2_UV		1335000
#define OMAP4460_VDD_MPU_OPPNITRO_UV		1365000
#define OMAP4460_VDD_MPU_OPPNITROSB_UV		1380000
#define OMAP4460_VDD_MPU_OPPNITROSB_UV_OC	1395000
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP70_UV, 20000, OMAP44XX_CONTROL_FUSE_MPU_OPP70, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP100_UV, 20000, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPTURBO_UV, 20000, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPTURBO2_UV, 20000, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO2, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV, 20000, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITROSB_UV, 20000, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITROSB_UV_OC, 20000, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
static struct omap_vdd_dep_volt omap446x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPP70_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP50_UV},
	...
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPTURBO2_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
	...
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITROSB_UV_OC, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	/* MPU OPP1 - OPP70 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 500000000, OMAP4460_VDD_MPU_OPP70_UV),
	/* MPU OPP2 - OPP100 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 700000000, OMAP4460_VDD_MPU_OPP100_UV),
	/* MPU OPP3 - OPP-Turbo */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 900000000, OMAP4460_VDD_MPU_OPPTURBO_UV),
	/* MPU OPP3 - OPP-Turbo2 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 1050000000, OMAP4460_VDD_MPU_OPPTURBO2_UV),
	/* MPU OPP4 - OPP-Nitro */
	...
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1650000000, OMAP4460_VDD_MPU_OPPNITROSB_UV_OC),
