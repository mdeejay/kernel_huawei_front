...
/* IOCTL commands */
typedef enum _HSI_CH_IOCTL_COMMAND_ {
	HSI_CH_IOCTL_GET_WRITE_TIMEOUT,
	HSI_CH_IOCTL_SET_WRITE_TIMEOUT,
}HSI_CH_IOCTL_COMMAND;

/* HSI CH Result type*/
enum {
	HSI_CH_RESULT_SUCCESS                =  0, /* Request executed successfully. */
	HSI_CH_RESULT_FAIL                       =  -1, /* Request executed failed. */
	HSI_CH_RESULT_ERROR                    = -2, /* Request execution failed. */
	HSI_CH_RESULT_INVALID_PARAM      = -3, /* Invalid param. */
};
