...
#define HSI_SET_WAKE_3_WIRES		(1 << 16)
//#define HSI_SET_WAKE_3_WIRES_MASK	0xfffeffff      //redefine, compiling warning;

#define HSR_WAKE_WIRES_MASK      0x00000001     //For HSR,CP->AP; 0,4-wire HSR; 1,3-wire HSR;   //Modify based on hsi_3wire.patch.20110915
#define HST_WAKE_WIRES_MASK      0x00000002     //For HST,AP->CP; 0,4-wire HST; 1,3-wire HST;   //Modify based on hsi_3wire.patch.20110915

//#define HSI_SET_WAKE_3_WIRES		(1 << 16)
#define HSI_SET_WAKE_READY_LVL_1	(1 << 17)
#define HSI_SET_WAKE_MODE_3_WIRES(channel)		(1 << (channel) |\
					HSI_SET_WAKE_3_WIRES |\
					HSI_SET_WAKE_READY_LVL_1)
