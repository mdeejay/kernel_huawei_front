...
static bool_t is_CI2CA_LOW_MHL_enabled(void)
{
	return get_mhl_ci2ca_value();
}
...
//
static	uint8_t PAGE_0_0X72 = 0x72;
static	uint8_t PAGE_1_0X7A = 0x7A;
static	uint8_t PAGE_2_0X92 = 0x92;
static	uint8_t PAGE_CBUS_0XC8 = 0xC8;

static void init_PAGE_values(void)
{
	//if (true == is_CI2CA_LOW_MHL_enabled())
