...
static ssize_t hdmi_audio_channel_show(struct device *dev,
               struct device_attribute *attr, char *buf)
{
       int r;
       r = audio_channel_max;
...
static DEVICE_ATTR(audio_channel, S_IRUGO  | S_IWUSR, hdmi_audio_channel_show, NULL);
