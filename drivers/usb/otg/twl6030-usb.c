...
#define VBUS_MEAS		(1 << 0)
#define VBUS_ACT_COMP	(1 << 2)
#define ID_MEAS         (1 << 0)
#define ID_ACT_COMP     (1 << 2)
#define ID_SRC_16U      (1 << 4)
static enum plugin_status plugin_stat;
struct twl6030_usb {
...
enum plugin_status get_plugin_device_status(void)
{
	return plugin_stat;
}
EXPORT_SYMBOL_GPL(get_plugin_device_status);
