...
config_pair  u9500et3_hw_configs_common [] = {
    ...
    {"lcd_type/video_type", (unsigned int)1, E_CONFIG_DATA_TYPE_BOOL }, 
    ...
    {"proximity/threshold", (unsigned int)2, E_CONFIG_DATA_TYPE_INT }, 
...
struct board_id_general_struct u9500et3_hw_configs= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_U9500ET3,
	.data_array={.config_pair_ptr=u9500et3_hw_configs_common},
	.list={NULL,NULL},
};
