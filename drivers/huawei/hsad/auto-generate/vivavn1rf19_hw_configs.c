...
config_pair  vivavn1rf19_hw_configs_common [] = {
...
struct board_id_general_struct vivavn1rf19_hw_configs= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_VIVAVN1RF19,
	.data_array={.config_pair_ptr=vivavn1rf19_hw_configs_common},
	.list={NULL,NULL},
};
