...
config_pair  vivavn2rf19_hw_configs_common [] = {
    ...
    {"gas_gauge/capacity", (unsigned int)1650, E_CONFIG_DATA_TYPE_INT }, 
    ...
    {"gas_gauge/firmware_name", (const unsigned int)(unsigned int*)"BQ27510_SDI_1650", E_CONFIG_DATA_TYPE_STRING }, 
    {"gas_gauge/version", (unsigned int)0x16000a5, E_CONFIG_DATA_TYPE_INT }, 
...
struct board_id_general_struct vivavn2rf19_hw_configs= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_VIVAVN2RF19,
	.data_array={.config_pair_ptr=vivavn2rf19_hw_configs_common},
	.list={NULL,NULL},
};
