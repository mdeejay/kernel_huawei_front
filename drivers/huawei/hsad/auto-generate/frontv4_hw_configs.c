...
config_pair  frontv4_hw_configs_common [] = {
    ...
    {"touchscreen/front", (unsigned int)1, E_CONFIG_DATA_TYPE_BOOL }, 
...
struct board_id_general_struct frontv4_hw_configs= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_FRONTV4,
	.data_array={.config_pair_ptr=frontv4_hw_configs_common},
	.list={NULL,NULL},
};
