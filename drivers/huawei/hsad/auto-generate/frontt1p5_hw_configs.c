...
config_pair  frontt1p5_hw_configs_common [] = {
    ...
    {"leds/leds_type", (const unsigned int)(unsigned int*)"dmtimer", E_CONFIG_DATA_TYPE_STRING }, 
    {"mhl/ci2ca_is_pull_up", (unsigned int)0, E_CONFIG_DATA_TYPE_BOOL }, 
    ...
    {"proximity/thresdold", (unsigned int)0x1, E_CONFIG_DATA_TYPE_INT }, 
...
struct board_id_general_struct frontt1p5_hw_configs= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_FRONTT1P5,
	.data_array={.config_pair_ptr=frontt1p5_hw_configs_common},
	.list={NULL,NULL},
};
