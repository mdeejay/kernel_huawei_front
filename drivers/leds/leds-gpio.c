...
#include <asm/gpio.h>
//del some lines and add head files
	...
	enum led_brightness value)
{
	...
	int level;
//del some lines about dts2011091605697
	if (value == LED_OFF)
		level = 0;
	else
		level = 1;
...
//del a method to control leds.for this file is only for viva t1.
		{
...
//del probe of alpha version ,and use probe of g4 version
...
static int __devinit gpio_led_probe(struct platform_device *pdev)
{
	...
	if(get_board_id_int() != BOARD_ID_VIVA)
		return -ENODEV;
