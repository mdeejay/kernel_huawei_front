/*
 * LEDs driver for TCA6507 for huawei co.
 *
 *
 * This program is free software; you can redistribute it and/or modify
 * it under the terms of the GNU General Public License version 2 as
 * published by the Free Software Foundation.
 * the whole file is for DTS2011123103036
 */
...
static char config_name[LEDS_CONFIG_NAME_LENGTH] = "unknown";
...
{
    int ret, error;
    dev_info(&client->dev, "Three colors leds probe begin!\n");
    ...
    if (ret < 0)
    {
        dev_err(&client->dev, "unable to get EN GPIO 121!\n");
        ret = -ENODEV;
        goto err_free_mem;
    }
