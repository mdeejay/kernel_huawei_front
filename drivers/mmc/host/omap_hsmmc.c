...
#define HOTPLUG_SDCARD_LIMIT_TIME  2  //second
/*
...
static void omap_hsmmc_detect(struct work_struct *work)
{
	...
	if (carddetect){
		duration = jiffies - tisdcc_irqtime;
		if( duration <  ( HZ * HOTPLUG_SDCARD_LIMIT_TIME ) ){
			mmc_detect_change(host->mmc, (HZ * HOTPLUG_SDCARD_LIMIT_TIME * 1000) / 1000);
		}else{
